...
import { credentialsJson, serverUrl } from '../types'
...
export default function Signin({signedIn}){
    ...
    const handleSubmit = (e) =>{
        ...
        console.log('Input Value:',passwordRef.current.value)
            ...
            .then((response) =>{
                setLoading(false)
                response.json().then((r:credentialsJson)=>{localStorage.writerJwtToken=r.jwtToken;localStorage.uuid=r.uuid;console.log(r);})
    ...
    return(
        <div className={styles.mainBox}>
            <div className={styles.heading}>Writer Login</div>
